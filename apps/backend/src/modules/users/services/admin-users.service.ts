...
/**
 * Servicio de administración de usuarios por parte de administradores
 * Responsabilidades:
 * - Invitar profesionales y operadores de laboratorio
...
export class AdminUsersService {
  ...
  async inviteUser(
    ...
    // TODO: Integrar EmailService cuando esté disponible
   ...
   */
  async listUsersInOrganization(organizationId: string) {
   ...
   */
  async updateUser(userId: string, organizationId: string, dto: UpdateUserDto) {
