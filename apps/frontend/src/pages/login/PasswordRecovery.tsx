      ...
      <div className="w-full max-w-md">
        <div className="bg-white backdrop-blur-xl border  p-8 rounded-2xl shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-black mb-5">¿Has olvidado tu contraseña?</h1>
            <p className="text-slate-400 text-black">
              Introduce tu correo electronico profesional. Te enviaremos un enlace para restablecer tu acceso.
            </p>
          </div>
